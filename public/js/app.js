...
addToCart.forEach(function (btn) {
  btn.addEventListener('click', function (e) {
    var pizza = JSON.parse(btn.dataset.pizza); // used JSON.parse to convert string into object
    updateCart(pizza);
  });
});
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkpizza_dilevery_application"] = self["webpackChunkpizza_dilevery_application"] || [];
